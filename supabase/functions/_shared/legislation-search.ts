/**
 * Busca de legislação (Senado SCON → dadosabertos → fallback estático).
 * Extraído de `search-legislation/index.ts` para poder ser reusado por outras
 * edge functions sem arrastar junto um `serve()` no nível superior.
 */
...
export async function searchLegislation(termo: string, _tipoNorma?: string, _ano?: number): Promise<NormaResumo[]> {
  ...
  if (results.length === 0) {
    ...
    const staticLaws: Record<string, NormaResumo[]> = {
      ...
      alimentos: [
        { codigo: "5478", tipoNorma: "Lei", numero: "5.478", ano: "1968", ementa: "Lei de Alimentos", dataPublicacao: "25/07/1968", url: "https://www.planalto.gov.br/ccivil_03/leis/l5478.htm" },
      ],
      locacao: [
        { codigo: "8245", tipoNorma: "Lei", numero: "8.245", ano: "1991", ementa: "Lei do Inquilinato", dataPublicacao: "18/10/1991", url: "https://www.planalto.gov.br/ccivil_03/leis/l8245.htm" },
      ],
      tributario: [
