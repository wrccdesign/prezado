...
function supabasePublishableKey(): string {
  ...
  if (keyset) {
    try {
      ...
      /* dicionário malformado; tenta os nomes legados */
    }
  }
...
/** Sem identidade do chamador: RLS roda como `anon`. */
...
/** Repassa o token verificado para que a RLS rode como o usuário autenticado. */
