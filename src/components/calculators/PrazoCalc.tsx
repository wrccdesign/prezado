        ...
        <div className="space-y-4">
          <div className={"rounded-lg border border-cream-dark bg-white " + bgPrazo}>
            <div className="p-5 space-y-3">
              <p className="text-reading text-navy/70">Data de vencimento do prazo:</p>
              <p className={cn("text-2xl capitalize", corPrazo)}>
                {format(parseISO(result.data_vencimento), "EEEE, dd 'de' MMMM 'de' yyyy", { locale: ptBR })}
              </p>
              <div className={cn("text-reading font-medium", corPrazo)}>
              ...
              <div className="grid gap-1 text-note text-navy/60 sm:grid-cols-3 pt-2">
              ...
              {(codigoIbge && codigoIbge !== "__todos__") || (tribunal && tribunal !== "__nenhum__") ? (
                <div className="text-note text-navy/60 pt-1">
              ...
              {RECURSOS_COM_PREPARO.includes(tipoPrazo) && (
                <p className="pt-2 text-note text-navy/60">
                    ...
                    <TableBody>
                      {result.dias_excluidos.map(d => (
                        <TableRow key={d.data}>
                          ...
                          <TableCell className="text-reading text-navy/70">{d.motivo}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
