...
export default function Diagnostico() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <SEO title="Diagnóstico Jurídico com IA — HonorÃ­fico" description="Descreva sua situação em linguagem simples e receba diagnóstico jurídico estruturado: direitos, riscos e próximos passos." path="/diagnostico" />
      <LegalDisclaimer />
