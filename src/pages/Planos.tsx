...
export default function Planos() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <AppHeader />
      <SEO title="Planos e Preços — HonorÃ­fico" description="Compare os planos Gratuito, Profissional e Escritório do HonorÃ­fico. Assine e desbloqueie todas as ferramentas de IA jurídica." path="/planos" />
