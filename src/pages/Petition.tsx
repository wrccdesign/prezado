...
export default function Petition() {
  ...
  if (generatedText) {
    return (
      ...
      <SEO title="Geração de Petições com IA — HonorÃ­fico" description="Gere petições jurídicas fundamentadas em segundos. Download em PDF e DOCX, prontas para protocolo." path="/peticao" />
        <LegalDisclaimer />
