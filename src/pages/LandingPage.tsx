...
const testimonials = [
  { name: "Dra. Carolina Mendes", role: "Advogada Trabalhista, São Paulo", text: "O Prezado.ai reduziu o tempo de elaboração das minhas petições pela metade. A qualidade da análise é impressionante.", stars: 5 },
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div data-reveal className="opacity-0 translate-y-6 transition-all duration-700">
              ...
              <div className="flex gap-8 text-sm">
                {[{ value: "25+", label: "Tipos de Petição" }, { value: "6", label: "Leis Integradas" }, { value: "100%", label: "Direito BR" }].map((s) => (
                  <div key={s.label}>
      ...
      <section id="como-funciona" className="py-20 md:py-28" style={{ backgroundColor: "hsl(var(--navy))" }}>
        <div className="container mx-auto px-4 sm:px-6">
          <div data-reveal className="opacity-0 translate-y-6 transition-all duration-700 text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-white mt-3">Simples como deve ser</h2>
          </div>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: "hsl(var(--cream))" }}>
        <div className="container mx-auto px-4 sm:px-6">
          <div data-reveal className="opacity-0 translate-y-6 transition-all duration-700 text-center mb-14">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-navy mt-3">Feito para quem precisa do Direito</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div data-reveal className="opacity-0 translate-y-6 transition-all duration-500 rounded-2xl p-8 text-white" style={{ backgroundColor: "hsl(var(--navy))" }}>
              ...
              <ul className="space-y-3 mb-6">
                {["Geração automática de petições com IA", "Painel completo com gestão de clientes", "Análise inteligente de documentos", "Calculadoras trabalhistas integradas", "Download em PDF e DOCX"].map((b) => (
            ...
            <div data-reveal className="opacity-0 translate-y-6 transition-all duration-500 delay-100 rounded-2xl border border-border bg-white p-8">
              ...
              <ul className="space-y-3 mb-6">
                {["Diagnóstico jurídico em linguagem simples", "Entenda seus direitos sem jargão", "Chat com IA para tirar dúvidas", "Orientação sobre onde buscar ajuda", "Geração de petições para Juizado Especial"].map((b) => (
                  <li key={b} className="flex items-start gap-3 text-sm text-muted-foreground"><Check className="h-4 w-4 text-gold mt-0.5 shrink-0" />{b}</li>
                ))}
              </ul>
      ...
      <section id="depoimentos" className="py-20 md:py-28" style={{ backgroundColor: "hsl(var(--cream-dark))" }}>
        <div className="container mx-auto px-4 sm:px-6">
          <div data-reveal className="opacity-0 translate-y-6 transition-all duration-700 text-center mb-14">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-navy mt-3">O que dizem nossos usuários</h2>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.map((t, i) => (
              <div key={t.name} data-reveal className="opacity-0 translate-y-6 transition-all duration-500 bg-white rounded-xl border border-border p-6 hover:-translate-y-1 hover:shadow-md" style={{ transitionDelay: `${i * 100}ms` }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          <div data-reveal className="opacity-0 translate-y-6 transition-all duration-700">
            ...
            <p className="text-white/50 max-w-lg mx-auto mb-8 text-lg">
              Junte-se a milhares de advogados e cidadãos que já usam a Prezado.ai para democratizar o acesso ao direito.
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[{ label: "Análise Jurídica", href: "/auth" }, { label: "Diagnóstico", href: "/auth" }, { label: "Petições", href: "/auth" }, { label: "Chat Jurídico", href: "/auth" }].map((l) => (
