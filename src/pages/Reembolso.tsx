  ...
  return (
    ...
    >
      ...
      <p>
        ...
        Consumidor. Isso vale também para o <strong>plano anual pago à vista</strong> (cartão). Após os
      ...
      <ul>
        ...
        <li>Reembolsos são devolvidos ao mesmo meio de pagamento usado na compra.</li>
