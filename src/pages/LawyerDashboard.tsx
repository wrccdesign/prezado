...
export default function LawyerDashboard() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <AppHeader />
      <SEO title="Painel do Advogado — Honorífico" description="Gestão de clientes, petições, modelos e configurações do escritório. Painel completo do Honorífico." path="/painel-advogado" />
      <LegalDisclaimer />
