...
export default function ModelosMinutas() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <AppHeader />
      <SEO
        title="Modelos de Minutas e Peças Jurídicas Editáveis — HonorÃ­fico"
      ...
      <main className="container py-8 sm:py-12 px-4 sm:px-6 space-y-8">
        <header className="max-w-3xl space-y-4">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            ...
            caso — ou gere uma minuta personalizada com a IA do HonorÃ­fico.
          </p>
        ...
        <section className="prose dark:prose-invert max-w-none">
          ...
          <p>
            O HonorÃ­fico não substitui a atuação de advogado(a). O uso dos modelos é de
