  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>Dados de pagamento:</strong> os dados de cartão são coletados e processados diretamente pelo Asaas (provedor certificado PCI-DSS); o Honorífico recebe apenas identificadores de transação, status da assinatura, plano contratado e e-mail do pagador.</li>
      ...
      <ul>
        ...
        <li><strong>Asaas</strong> — processamento de pagamentos, prevenção a fraudes e emissão de recibos. Consulte a <a href="https://www.asaas.com" target="_blank" rel="noopener noreferrer">Política de Privacidade do Asaas</a>.</li>
